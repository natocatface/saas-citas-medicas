{{-- Vars: $usuario, $roles, $action, $method --}}
        ...
        <form method="POST" action="{{ $action }}" class="space-y-5">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
                ...
                <div>
                    ...
                    <select name="rol" required class="w-full rounded-lg border-slate-300 text-sm focus:border-brand-500 focus:ring-brand-500">
            ...
            <div class="rounded-xl bg-slate-50 border border-slate-200 p-4 space-y-4">
                ...
                @if($esEdicion)
                    <p class="text-xs text-slate-400 -mt-2">Déjala en blanco para mantener la actual.</p>
                @endif
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
                    <div>
            ...
            <div class="flex items-center gap-3 pt-2">
                ...
                <a href="{{ route('usuarios.index') }}" class="text-sm font-medium text-slate-500 hover:text-slate-700">Cancelar</a>
            </div>
        </form>
    </div>
</div>
